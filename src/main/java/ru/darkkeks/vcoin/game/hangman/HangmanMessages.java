...
public class HangmanMessages {
    ...
    public static final String COMMANDS_MESSAGE = "❗ Включите отображение клавиатуры (в правом углу поля для ввода сообщения)";
    ...
    public static final String RULES_MESSAGE = "📜 Правила игры виселица\n\n" +
            ...
            "Вы должны присылать мне буквы, о которых хотите получить информацию. Если буква есть в слове, то я покажу все позиции," +
            "где эта буква встречается. Но если этой буквы нет в слове, я добавлю на виселицу одну часть Вашего тела. " +
            "У вас есть всего 6 попыток, чтобы выиграть.\n\nМонеты забирает тот, кто выиграл! Стоимость одной игры: %s" +
            "🔴 Более подробно можно ознакомиться с правилами на википедии: vk.cc/9hRoBS";
