...
public class HangmanMessages {
    ...
    public static final String LANGUAGE_ENGLISH = "Язык: 🇺🇸 English";
    public static final String LANGUAGE_RUSSIAN = "Язык: 🇷🇺 Russian";
    ...
    public static final String ENABLED_ENGLISH_LANGUAGE = "✅ Включен английский язык";
    public static final String ENABLED_RUSSIAN_LANGUAGE = "✅ Включен русский язык";
    ...
    public static final String WIN_MESSAGE = "🏆 Вы выиграл\u2063и. Ну ничего, в следующий раз победа будет на моей стороне!";
    public static final String LOSE_MESSAGE = "😢 Вы про\u2063играли...";
    ...
    public static final String BALANCE_MESSAGE = "💰 Ваш бал\u2063анс: %.3f монет";
    public static final String GAME_STATUS_MESSAGE = "📗 Отгад\u2063анные буквы: %s\n👿 Неверные попытки: %s";
    public static final String HEALTH_MESSAGE = "\nПопытки: %s";
    public static final String TOO_MUCH_PROFIT = "К сожалению, Вы выиграли сегодня сли\u2063шком много. Платные игры будут " +
            "доступны в 00:00 по МСК. Бесплатные игры можно включить в настройках";
    public static final String RULES_MESSAGE = "📜 Правила игры виселица\n\nЯ загадываю очень сложное " +
            ...
            "определение слова или нет.\n\nЗапрещено использовать сторонние приложения для игры в Виселицу.";
